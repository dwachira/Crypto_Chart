...
public class Portfolio_Value 
{
    public String portfolio_value_calculation(String BTC_coins, String ETH_coins, String XRP_coins, String ADA_coins, String XLM_coins, String MIOTA_coins, String TRX_coins, String VEN_coins, String OMG_coins, String XVG_coins, String KCS_coins, String UTK_coins, String BRD_coins, String APPC_coins, String SUB_coins, String CV_coins)
    {
      ...
      { 
        ...
        if (Double.parseDouble(BTC_coins) > 0)
        { 
        ...
        if (Double.parseDouble(ETH_coins) > 0)
        { 
        ...
        if (Double.parseDouble(XRP_coins) > 0)
        { 
        ...
        if (Double.parseDouble(ADA_coins) > 0)
        { 
        ...
        if (Double.parseDouble(XLM_coins) > 0)
        { 
        ...
        if (Double.parseDouble(MIOTA_coins) > 0)
        { 
        ...
        if (Double.parseDouble(TRX_coins) > 0)
        { 
        ...
        if (Double.parseDouble(VEN_coins) > 0)
        { 
        ...
        if (Double.parseDouble(OMG_coins) > 0)
        { 
        ...
        if (Double.parseDouble(XVG_coins) > 0)
        { 
        ...
        if (Double.parseDouble(KCS_coins) > 0)
        { 
        ...
        if (Double.parseDouble(UTK_coins) > 0)
        { 
        ...
        if (Double.parseDouble(BRD_coins) > 0)
        { 
        ...
        if (Double.parseDouble(APPC_coins) > 0)
        { 
        ...
        if (Double.parseDouble(SUB_coins) > 0)
        { 
        ...
        if (Double.parseDouble(CV_coins) > 0)
        { 
